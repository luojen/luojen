            ...
            <div className={`h-full w-full mb-8`}>
                ...
                <div className={`h-full w-full min-h-[800px] sm:min-h-[700px] p-8 flex flex-col bg-[#202020] text-[#FCFCFC] relative`} id="slide-1">
                    ...
                    <div className={`h-full flex flex-col justify-end relative`}>
                        ...
                        {/* <div className={`ml-4`}> */}
                        {/* <CustomImage className={`xs:w-[300px] xs:h-[250px] sm:w-[350px] sm:h-[300px] md:w-[600px] md:h-[400px] absolute xs:left-0 xs:top-5 sm:left-auto sm:top-auto sm:bottom-4 sm:right-0`} src={"/assets/downballot/final_prototype.gif"} alt={"GIF of final prototype for Downballot"} fill={true}/> */}
                        {/* </div> */}
                    ...
                    >
                        ...
                        <div className={`flex flex-col md:flex-row mt-16`}>
                            ...
                            <div className={`flex flex-col mt-10 md:mt-0`}>
                                {/* <CustomImage className={`w-full sm:max-w-[800px] self-end rounded-xl shadow-lg mb-8`} src={"/assets/downballot/site_structures.gif"} alt={"GIF of final prototype for Downballot"} fill={false} width={500} height={500}/> */}
